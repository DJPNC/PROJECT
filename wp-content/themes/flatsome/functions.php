       ...
       <form action="" method="post" class="form_datve">
            <div style="display:flex;">
                <div class="total">
                    ...
                    <input required type="text" name="tien" value="360.000 VND">
                </div>
                ...
                <div class="ngay" style="margin-left: 5px;">
                    ...
                    <input required type="date" name="ngay" value="15/08/2022">
                </div>
            </div>
            <div class="name"> 
    ...
    ?>
       <form action="thanh-toan-thanh-cong" method="post" class="form_datve">
            ...
            <div class="ngay" style="">
                ...
                <input required type="date" name="ngay" value="08/2027">
            </div>
            <div class="CVV" >
